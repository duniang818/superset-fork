##### 0.1.1.1.1 1、首先需要检查你电脑是否已经有 SSH key 
...
接着又会提示你输入两次密码（该密码是你push文件的时候要输入的密码，而不是[github](https://so.csdn.net/so/search?q=github&spm=1001.2101.3001.7020)管理者的密码），
...
# 3 Your public key has been saved in /c/Users/you/.ssh/id_rsa.pub.
# 4 The key fingerprint is:
# 5 01:0f:f4:3b:ca:85:d6:17:a1:7d:f0:68:9d:f0:a2:db your_email@example.com

当你看到上面这段代码的收，那就说明，你的 SSH key 已经创建成功，你只需要添加到github的SSH key上就可以了。

##### 5.1.1.1.1 3、添加你的 SSH key 到 github上面去
