...
export default class EchartsWaterfallcopyChartPlugin extends ChartPlugin<
...
> {
  ...
  constructor() {
    super({
      buildQuery,
      controlPanel,
      loadChart: () => import('./EchartsWaterfallcopy'),
      metadata: new ChartMetadata({
        behaviors: [Behavior.InteractiveChart],
        credits: ['https://echarts.apache.org'],
        category: t('Evolution'),
        description: t(
          `Coco copy !A waterfall chart is a form of data visualization that helps in understanding
