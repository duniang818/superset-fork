...
export default class EchartsWaterfall2ChartPlugin extends ChartPlugin<
...
> {
  ...
  constructor() {
    super({
      buildQuery,
      controlPanel,
      loadChart: () => import('./EchartsWaterfall2'),
      metadata: new ChartMetadata({
        behaviors: [Behavior.InteractiveChart],
        credits: ['https://echarts.apache.org'],
        category: t('Evolution'),
        description: t(
          `A waterfall chart 2 is a form of data visualization that helps in understanding
